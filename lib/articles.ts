...
export const ARTICLES_DATA: ArticleItem[] = [
  ...
  {
    title: 'Best Mechanical Keyboards for Coding & Gaming in India',
    excerpt: 'Testing tactile switches, hot-swappable PCBs, wireless Bluetooth connectivity, and RGB lighting for developers.',
    category: 'Computers',
    categorySlug: 'computers',
  ...
  {
    title: 'Best Coding Monitors Under ₹15,000 in India',
    excerpt: 'IPS panels, USB-C power delivery, height-adjustable stands, and eye-care blue light filters for software engineers.',
    category: 'Monitors',
