...
export const SAMPLE_PRODUCTS: CategoryContentItem[] = [
  ...
  // ─── WEARABLES ──────────────────────────────────────────────────────────────
  {
    ...
    description: 'Samsung\'s most rugged and capable smartwatch — Grade 4 Titanium frame, 3nm Exynos W1000, Sapphire crystal, 100-hour battery, and advanced health tracking with ECG, Blood Pressure, and SpO2.',
    category: 'Wearables',
    subcategorySlug: 'smartwatches',
    href: '/products/samsung-galaxy-watch-ultra',
    ...
    specs: [
      ...
      { label: 'Build', value: 'Grade 4 Titanium + Sapphire Crystal' },
      { label: 'Battery', value: '590mAh — up to 100hrs' },
      { label: 'Health', value: 'ECG, BP, SpO2, Heart Rate' },
