...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    active: true,
    subcategories: [
      { name: 'Smartwatches', slug: 'smartwatches', active: true, count: 1, description: 'Apple Watch, Galaxy Watch, Garmin, and feature smartwatches.' },
...
export const SAMPLE_PRODUCTS: CategoryContentItem[] = [
  ...
  {
    title: 'vivo X300 FE 5G',
    description: 'vivo X300 FE 5G with Urban Olive finish, 12GB RAM, 256GB storage, and advanced portrait camera system.',
    category: 'Mobiles',
    subcategorySlug: 'android',
    href: '/products/vivo-x300-fe',
    image: '/products/vivo-x300-fe.png',
    rating: 8.9,
    price: 'Check Price',
    ...
    specs: [
      { label: 'RAM & Storage', value: '12GB RAM / 256GB' },
      { label: 'Camera', value: 'Pro Portrait System' },
      { label: 'Design', value: 'Urban Olive Finish' },
  ...
  {
    title: 'Samsung Galaxy S26 Plus 5G',
    description: '12GB RAM, 512GB Storage, AI Phone with Photo Assist and Creative Studio, 50MP Camera, and 4900mAh Battery with Super Fast Wireless Charging.',
    category: 'Mobiles',
    subcategorySlug: 'smartphones',
    href: '/products/samsung-galaxy-s26-plus',
    ...
    specs: [
      { label: 'Camera', value: '50MP with Photo Assist AI' },
      { label: 'Battery', value: '4900mAh Super Fast Charging' },
      { label: 'Storage & RAM', value: '512GB Storage / 12GB RAM' },
    ],
  },
  // ─── SMART HOME ─────────────────────────────────────────────────────────────
  {
  ...
  // ─── WEARABLES ──────────────────────────────────────────────────────────────
  {
    title: 'Samsung Galaxy Watch8 (Graphite)',
    description: 'Samsung\'s sleekest smartwatch yet — 3nm processor, Super AMOLED display with 3,000 nits brightness, Dynamic Lug System, sleep apnea detection, vascular load monitoring, and antioxidant index tracking.',
    category: 'Wearables',
    ...
    specs: [
      { label: 'Processor', value: '3nm Processor (Energy Efficient)' },
      { label: 'Display', value: 'Super AMOLED, 3,000 nits' },
      { label: 'Health', value: 'Sleep Apnea, Vascular Load, SpO2' },
      { label: 'Feature', value: 'Antioxidant Index Tracking' },
      { label: 'Design', value: 'Cushion Design + Dynamic Lug' },
    ],
  },
]
